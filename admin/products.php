...
if(isset($_GET['add']) || isset($_GET['edit'])){
  ...
  if($_POST){
    ...
    foreach($required as $field){
      if($_POST[$field] == ''){
        $errors[] = 'All Field With * are required.';
        break;
      }
    }
    if(!empty($_FILES)){
      ...
      $uploadPath = BASEURL.'Pixs/products/'.$uploadName;
      $dbpath = '/zitchat/Pixs/products/'.$uploadName;
      if($mimeType != 'image'){
    ...
    if(!empty($errors)){
      ...
      VALUES ('$title','$price','$list_price','$brand','$category','$sizes','$dbpath','$description')";
       if(isset($_GET['edit'])){
         ...
         brand = '$brand', categories = '$category', sizes = '$sizes', images = '$dbpath', description = '$description'
          WHERE id = '$edit_id'";
       }
  ...
  <div class="form-group col-md-6">
    <?php if($saved_image != ''): ?>
     <div class="saved-image">
       <img src="<?=$saved_image?>" atl="saved-image"/><br>
...
<h2 class="text-center">Products</h2>
 <a href="products.php?add=1" class="btn btn-success pull-right" id="add-product-btn">Add Products</a><div class="clearfix"></div>
<hr>
